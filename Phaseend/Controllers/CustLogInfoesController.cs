...
namespace Phaseend.Controllers
{
    ...
    {
        private readonly CslazureDbContext _context;

        public CustLogInfoesController(CslazureDbContext context)
        {
            _context = context;
        }
        ...
        {
            var cslazureDbContext = _context.CustLogInfos.Include(c => c.User);
            return View(await cslazureDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CslazureDbContext.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
