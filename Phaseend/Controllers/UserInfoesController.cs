...
namespace Phaseend.Controllers
{
    public class UserInfoesController : Controller
    {
        ...
        public UserInfoesController(CslazureDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.UserInfos != null ? 
                          ...
                          Problem("Entity set 'CslazureDbContext.UserInfos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CslazureDbContext.UserInfos'  is null.");
            }
            var userInfo = await _context.UserInfos.FindAsync(id);
            if (userInfo != null)
            {
